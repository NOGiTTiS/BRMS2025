                ...
                <form action="<?php echo URLROOT; ?>/booking/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="subject" class="w-full mt-1 px-3 py-2 border <?php echo (!empty($data['subject_err'])) ? 'border-red-500' : 'border-gray-300'; ?> rounded" value="<?php echo $data['subject']; ?>">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-4">
                        <div>
                            ...
                            <div class="flex gap-2 mt-1">
                                <input type="date" name="start_date" class="w-full px-3 py-2 border border-gray-300 rounded" value="<?php echo $data['start_date']; ?>">
                                <input type="time" name="start_time" class="w-full px-3 py-2 border border-gray-300 rounded" value="<?php echo $data['start_time']; ?>">
                            </div>
                        </div>
                         <div>
                            <label class="block text-gray-700">วัน-เวลา สิ้นสุด</label>
                            <div class="flex gap-2 mt-1">
                                <input type="date" name="end_date" class="w-full px-3 py-2 border border-gray-300 rounded" value="<?php echo $data['end_date']; ?>">
                                <input type="time" name="end_time" class="w-full px-3 py-2 border border-gray-300 rounded" value="<?php echo $data['end_time']; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid md:grid-cols-3 gap-6 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded" value="<?php echo $data['phone']; ?>">
                        </div>
                        <div>
                            <label for="attendees" class="block text-gray-700">จำนวนผู้เข้าร่วม</label>
                            <input type="number" name="attendees" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded" value="<?php echo $data['attendees']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="note" rows="3" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded"><?php echo $data['note']; ?></textarea>
                    </div>

                    <!-- Room Layout Image Upload -->
                    <div class="mb-4">
                        <label for="room_layout_image" class="block text-gray-700">รูปแบบการจัดห้อง (ถ้ามี)</label>
                        <input type="file" name="room_layout_image" id="room_layout_image" class="w-full mt-1 text-sm text-gray-500
                    ...
                    <button type="submit" class="bg-pink-500 text-white font-bold py-2 px-6 rounded-lg hover:bg-pink-600 transition">ส่งคำขอจอง</button>
                </form>
            </div>
        </main>
    </div>
