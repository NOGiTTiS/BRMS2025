        ...
        <main class="flex-1 p-4 md:p-8 overflow-x-auto">
            ...
            <div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
                ...
                <form action="<?php echo URLROOT; ?>/room/edit/<?php echo $data['id']; ?>" method="post">
                    <!-- Fields are the same as add.php -->
                    <div class="mb-4">
                    ...
                    <button type="submit" class="bg-pink-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-pink-600 transition">อัปเดต</button>
                </form>
            </div>
        </main>
    </div>
